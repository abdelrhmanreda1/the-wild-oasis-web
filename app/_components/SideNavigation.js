...
function SideNavigation({ isOpen, setIsOpen }) {
  ...
  return (
    <div className="md:h-full relative ">
      ...
      <nav className={`fixed top-20 left-0 h-[100%] bg-primary-950 shadow-3xl z-20 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex md:border-r md:border-primary-900`}>
