...
function CabinCard({ cabin }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row border-primary-800 border">
      <div className="relative w-full h-48 sm:h-auto sm:w-1/2">
        <Image src={image} fill alt={`Cabin ${name}`} className="object-cover w-full h-full border-r border-primary-800" />
      </div>
